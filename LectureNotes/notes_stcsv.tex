...
\label{sec:org5a6aadb}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:org7c256dc}
...
\caption{\label{fig:org9b296d4}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:org99636b9}Steiner's Method}
\end{figure}
