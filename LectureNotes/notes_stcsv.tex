...
\label{sec:org8c8e3f0}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:org9c85bb8}
...
\caption{\label{fig:org4a45116}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:orgcc042f6}Steiner's Method}
\end{figure}
...
\label{sec:org85252fd}

\section{The Inverse Function Theorem.}
\label{sec:org3183e4b}
\begin{thm}
