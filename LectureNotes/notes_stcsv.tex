...
\label{sec:orge1901f5}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:org473c861}
...
\caption{\label{fig:orgb7943f6}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:org0eba042}Steiner's Method}
\end{figure}
