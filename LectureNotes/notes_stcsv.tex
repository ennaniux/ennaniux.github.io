...
\label{sec:orgfa2f7e5}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:org4fdb3ff}
...
\caption{\label{fig:org704b395}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:org6f47772}Steiner's Method}
\end{figure}
