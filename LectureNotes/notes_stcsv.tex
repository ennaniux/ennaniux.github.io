...
\label{sec:org8abffe9}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:orgfa0e0d0}
...
\caption{\label{fig:orge2b8c3a}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:orgc1516d9}Steiner's Method}
\end{figure}
