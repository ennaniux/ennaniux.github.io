...
\label{sec:org5aa63ee}

\subsection{Curves in \(\mathbb{R}^3\)}
\label{sec:org06775d1}
...
\caption{\label{fig:org8e10af0}Dido's problem along the shore}
\end{figure}
...
\caption{\label{fig:orgc760e61}Steiner's Method}
\end{figure}
...
\begin{thm}
Suppose that \$f:\mathbb{R}\textsuperscript{n} \(\to\) \mathbb{R}\textsuperscript{n} is a continuously differentiable in an open set \(U\subset \mathbb{R}^n\) containing a point \(a\in U\), and suppose \(\det(Df_a) \neq 0\). Then there are open sets \(V,W\subset\mathbb{R}^n\), 
\end{thm}
